...
@section('content')
    ...
    <div style="filter: grayscale(0.7) brightness(0.95); opacity: 0.6; cursor: not-allowed;">
        <img src="/images/{{ $maq->imagen }}" alt="{{ $maq->nombre }}" />
        <div class="card-content">
...
<div id="modal-restaurar" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
