        ...
        <div class="col-lg-6 col-md-8">
            ...
            <div class="card shadow-lg border-0 recibo-card">
                ...
                <div class="card-header bg-success text-white text-center py-3">
                    <h4 class="mb-0 fw-bold">Reserva Realizada</h4>
                </div>
                
                <div class="card-body p-4">
                    <!-- Título -->
                    <div class="text-center mb-4">
                        <h5 class="text-success mb-2">Pago Exitoso</h5>
                        <p class="text-muted">
                            Tu reserva ha sido confirmada con éxito. Hemos enviado los detalles a tu correo electrónico.
                        </p>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-7">
                                ...
                                @else
                                    <span class="text-muted">{{ ucfirst($paymentData->status) }}</span>
                                @endif
                            </div>
                        </div>
                        <div class="row mb-2">
                    ...
                    @if(isset($nuevaReserva))
                    <div class="mb-4">
                        <div class="row mb-2">
                            <div class="col-5"><strong>Número de Reserva:</strong></div>
                            <div class="col-7 text-primary fw-bold">#{{ $nuevaReserva->id }}</div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-5"><strong>Máquina:</strong></div>
                            <div class="col-7">{{ $nuevaReserva->maquina->nombre ?? 'Máquina #' . $nuevaReserva->maquina_id }}</div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-5"><strong>Fecha de Inicio:</strong></div>
                            <div class="col-7">
                                {{ \Carbon\Carbon::parse($nuevaReserva->fecha_inicio)->format('d/m/Y H:i') }}
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-5"><strong>Fecha de Fin:</strong></div>
                            <div class="col-7">
                                {{ \Carbon\Carbon::parse($nuevaReserva->fecha_fin)->format('d/m/Y H:i') }}
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-5"><strong>Monto Total:</strong></div>
                            <div class="col-7 text-success fw-bold">
                                ${{ number_format($nuevaReserva->monto_total, 2) }}
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-5"><strong>Fecha de Reserva:</strong></div>
                            <div class="col-7">
                                {{ \Carbon\Carbon::parse($nuevaReserva->fecha_reserva)->format('d/m/Y H:i') }}
                            </div>
                        </div>
                    </div>
                    @endif
