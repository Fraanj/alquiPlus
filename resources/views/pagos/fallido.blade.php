        ...
        <div class="col-lg-6 col-md-8">
            ...
            <div class="card shadow-lg border-0 recibo-card">
                ...
                <div class="card-header bg-danger text-white text-center py-3">
                    <h4 class="mb-0 fw-bold">Pago Rechazado</h4>
                </div>
                
                <div class="card-body p-4">
                    <!-- Título -->
                    <div class="text-center mb-4">
                        <h5 class="text-danger mb-2">Pago no procesado</h5>
                        <p class="text-muted">
                    ...
                    <div class="text-center mt-4">
                        <!-- BOTÓN OCULTADO PORQUE NO SE IMPLEMENTÓ!!!!
                        <a href="{{ route('reservas.create') }}" class="btn btn-danger btn-lg px-4 me-2">
                            Intentar Nuevamente
                        </a>
                        -->
