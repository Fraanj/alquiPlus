        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                ...
                <h1 class="text-2xl font-bold text-green-700 mb-6 flex items-center">
                    <i class="bi bi-bar-chart-fill me-2"></i> Estadísticas de Reservas Totales
                </h1>
                ...
                <form method="GET" action="{{ route('estadisticas.reservasTotales') }}" class="mb-6">
                    ...
                    <button type="submit" class="mt-6 bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-6 rounded shadow">
                ...
                @if(isset($total))
                    <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded mb-6">
                        <strong>Total de reservas:</strong> {{ $total }}
                    </div>
                @endif
                ...
                @elseif(isset($total) && $total == 0)
                    <p class="text-gray-500 italic mt-4">No se encontraron reservas en el rango de fechas seleccionado.</p>
                @endif

                <a href="{{ route('estadisticas') }}" class="inline-block mt-8 text-green-700 hover:underline">
